...
import { Formatter } from '../../../../shared/utils/index';

function cellPhoneValidator(abstractControl: AbstractControl): ValidatorFn {

    const _numberRegExp: RegExp = /^([6-9]{1}[0-9]{8})$/mg;
    ...
    function buildResponse(isValid: boolean): any {
        return isValid ? null : { message: 'Telefone Celular inválido.' };
    }
